 ...
 * class to implement {@link String} constants in order to make it considerably
 * hard (although still not impossible) for a reverse engineer to find these
 * string literals while providing comparably fast operation and minimum memory
 * footprint.
 * <p>
 ...
 * <p>
 * For example, if we want to use the string literal <tt>"cool.passwd"</tt> then
 * we would run the code below
 * 
 * <pre>
 ...
 * expensive in terms of resources&mdash;no matter what algorithm is actually
 * used. More importantly, encrypting string literals in Java code does not
 * really increase the privacy of these strings compared to obfuscation as long
 * as the encryption key is still placed in the Java code itself and tracing the
 * calls to the JVM is possible. Hence, obfuscation is selected in favor of
 * encryption.
 * <p>
 ...
 * utility to search for all usages of this class.
 * <p>
