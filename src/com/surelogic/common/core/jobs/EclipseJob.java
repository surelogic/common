...
public final class EclipseJob {
     ...
     */
    public void scheduleDb(final SLJob job, final boolean user,
            final boolean system, final long delay, final String... accessKeys) {
        if (job == null) {
     ...
     */
    public void scheduleWorkspace(final SLJob job, final boolean user,
     ...
     */
    public void scheduleWorkspace(final SLJob job, final boolean user,
            final boolean system, final long delay) {
        if (job == null) {
            throw new IllegalArgumentException(I18N.err(44, "job"));
        }
