...
public final class ColumnAnnotation {
	 ...
	 * 
	 * @param value
	 *            the icon named quoted with single quotes. The quotes are
	...
	/**
	 * Indicates if the icon for this column should be displayed when the text
	 * in a row is blank. {@code true} indicates that it should, {@code false}
	 * that it should not.
	 */
	private boolean f_showIconWhenEmpty = true;

	/**
	 * Gets if the icon for this column should be displayed when the text in a
	 * row is blank.
	 * 
	...
	/**
	 * Sets if the icon for this column should be displayed when the text in a
	 * row is blank.
	 * 
	 * @param value
	 *            {@code true} indicates that the icon should be displayed when
	 *            the text in a row is blank, {@code false} that that the icon
	 *            should not be displayed when the text in a row is blank.
	 */
	...
	/**
	 * Checks if summary information should be displayed on a partial row with
	 * the passed number of columns. This is checking the contents of the
	 * <tt>on</tt> set.
	 * <p>
	 * If the <tt>on</tt> set is empty then this method always returns {@code
	 * true} as no <tt>on</tt> clause means to display summary information on
	 * all partial rows.
	 * 
	 * @param value
	 *            the column count to see if summary information should be
	 *            displayed.
	 * @return {@code true} if summary information should be displayed, {@code
	...
	public String toString() {
		return "[ColumnAnnotation: isValid=" + f_isValid + " icon="
				+ f_iconName + " justification=" + f_justification
				+ " isLastTreeColumn=" + f_isLastTreeColumn
				+ " isLastInitiallyVisible=" + f_isLastInitiallyVisible
				+ " isHidden=" + f_isHidden + " definesAnIconForAnotherColumn="
				+ f_definesAnIconForAnotherColumn + " sumPartialRows="
				+ f_sumPartialRows + " countPartialRows=" + f_countPartialRows
				+ " countDistinct=" + f_countDistinct + " onSet=" + f_onSet
				+ " suffix=" + f_suffix + "]";
	}
}
