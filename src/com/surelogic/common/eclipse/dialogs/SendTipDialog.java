...
public final class SendTipDialog extends TitleAreaDialog {
	...
	protected Control createDialogArea(Composite parent) {
		...
		sendUsage.setLayoutData(new GridData(SWT.DEFAULT, SWT.DEFAULT, false,
				false, 2, 1));
		sendUsage.setText(I18N.msg("common.send.tip.dialog.sendUsage"));
	...
	private final class Mediator {
		...
		public Mediator(Text email, Text name, Text summary, Text tip,
				Button sendVersion, Button sendUsage, Button previewButton) {
			f_email = email;
			f_name = name;
			f_summary = summary;
			f_tip = tip;
