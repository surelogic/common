...
/**
 * For apps that provide similar functionality, but use separate preference settings
 * (see IAutoPerspectiveSwitchPreferences)
 */
public abstract class AbstractCommonPreferencePage extends AbstractLicensePreferencePage {
	...
	protected AbstractCommonPreferencePage(String prefix, IAutoPerspectiveSwitchPreferences p) {
		messagePrefix = prefix;
		prefsBase = p;
	}
	
	public void init(IWorkbench workbench) {
		setPreferenceStore(prefsBase.getPreferenceStore());
	...
	protected void setupForPerspectiveSwitch(final Group group) {
		f_promptPerspectiveSwitch = new BooleanFieldEditor(
				prefsBase.getPrefConstant(IAutoPerspectiveSwitchPreferences.PROMPT_PERSPECTIVE_SWITCH),
				I18N.msg(messagePrefix+"preference.page.promptPerspectiveSwitch"),
				group);
		...
		f_autoPerspectiveSwitch = new BooleanFieldEditor(
				prefsBase.getPrefConstant(IAutoPerspectiveSwitchPreferences.AUTO_PERSPECTIVE_SWITCH),
				I18N.msg(messagePrefix+"preference.page.autoPerspectiveSwitch"),
				group);
