...
/**
 * Copied from ToolTipInformationControl
 * 
 * @author Edwin
 */
public class CompactToolTipInformationControl extends AbstractInformationControl {
	...
	public CompactToolTipInformationControl(final Shell parentShell,
	...
	protected void createContent(final Composite parent) {
		...
		tipLabel.setMenu(new Menu(getShell(), SWT.NONE));
	...
	public void setTip(String tipText) {
		...
		if (isResizable()) {
			setSize(7*tipText.length(), HEIGHT);
		}
	...
	public void setSize(final int width, final int height) {
		tipLabel.setRedraw(false); // avoid flickering
		try {
			super.setSize(width, height);
		} finally {
			tipLabel.setRedraw(true);
		}
	}
