...
import static com.surelogic.common.xml.XMLConstants.AMPERSAND;
import static com.surelogic.common.xml.XMLConstants.APOSTROPHE;
import static com.surelogic.common.xml.XMLConstants.DOUBLE_QUOTE;
import static com.surelogic.common.xml.XMLConstants.GREATER_THAN;
import static com.surelogic.common.xml.XMLConstants.LESS_THAN;
...
public class XMLUtil {
	...
	public static void parseResource(Logger log, SAXParser sp, InputStream in,
		...
		for (int i = 0; i < str.length(); i++) {
			...
			if (c != '&')
				...
				if (entity.equals(LESS_THAN))
					result.append('<');
				else if (entity.equals(GREATER_THAN))
					result.append('>');
				else if (entity.equals(DOUBLE_QUOTE))
					result.append('"');
				else if (entity.equals(APOSTROPHE))
					result.append('\'');
				else if (entity.equals(AMPERSAND))
					result.append('&');
				i = entityEnd;
			}
		}
