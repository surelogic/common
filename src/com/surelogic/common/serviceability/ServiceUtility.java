...
public final class ServiceUtility {
   ...
   *          {@code true} if OS, Java, and IDE version information should be
   *          included in the generated tip, {@code false} if not.
   * @param ideVersion
   *          a string representing the version of the IDE that created this
   *          tip. The OS and Java versions are looked up by this method.
   * @param includeUsage
   *          {@code true} if data from the SureLogic feature usage log should
   ...
   * @param includeVersionInfo
   *          {@code true} if OS, Java, and IDE version information should be
   *          included in the generated problem report, {@code false} if not.
   * @param ideVersion
   *          a string representing the version of the IDE that created this
   ...
   * @param includeUsage
   *          {@code true} if data from the SureLogic feature usage log should
   *          be included in the generated problem report, {@code false} if not.
   * @param ideLogFile
   ...
   * @param issuedTo
   *          the name of the person or company to whom the license was issued.
   * @param licenseId
   *          the license identifier.
   * @return a notice that a license was installed or uninstalled in a format to
   *         send to SureLogic.
   */
    ...
    return new SLJob() {
      ...
      public SLStatus run(final SLProgressMonitor monitor) {
        ...
        try {
          ...
          return SLStatus
              .createErrorStatus(I18N.err(154, f_serviceLocation), e);
        }
