...
public class LicenseManager implements LicenseCreator, LicenseVerifier {
    ...
    private static final String SUBJECT = new OString(new long[] {
        0xA1CB7D9B4D5E81E4L, 0xD9500F23E58132B6L
    }).toString(); /* => "subject" */

    private static final String KEY_STORE_PARAM = new OString(new long[] {
        0x449C8CDCBA1A80CEL, 0x6FEE3A101634D30BL, 0xD9D7B61A44A2606CL
    }).toString(); /* => "keyStoreParam" */

    private static final String CIPHER_PARAM = new OString(new long[] {
        0xCD54DEE1845B54E4L, 0x1AC47C8C827054BCL, 0x16E53B3A590D62B6L
    }).toString(); /* => "cipherParam" */

    protected static final String CN = new OString(new long[] {
    ...
    private static final String EXC_CONSUMER_AMOUNT_IS_NOT_ONE = new OString(new long[] {
    ...
    private static final String EXC_CONSUMER_AMOUNT_IS_NOT_POSITIVE = new OString(new long[] {
    ...
    private static final String FILE_FILTER_DESCRIPTION = new OString(new long[] {
        0x2BDDE408C7B71604L, 0xDFCA7DA8912DE4C1L, 0xADA1FC1C1D5F1047L,
        0xD08EAA6CCDC342F3L
    }).toString(); /* => "fileFilter.description" */

    private static final String FILE_FILTER_SUFFIX = new OString(new long[] {
