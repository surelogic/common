      ...
      public IStatus runInUIThread(IProgressMonitor monitor) {
        synchronized (BalloonUtility.class) {
          ...
          if (shell == null) {
            ...
            return SLEclipseStatusUtility.createErrorStatus(errNo, msg, new Exception());
          }

          /*
           * We need to position the balloon relative to the main Eclipse
           * window. This puts it at the bottom-left a few pixels in diagonal up
