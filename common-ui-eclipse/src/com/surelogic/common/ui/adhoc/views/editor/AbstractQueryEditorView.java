...
public abstract class AbstractQueryEditorView extends ViewPart {
	...
	public void createPartControl(final Composite parent) {
		...
		f_mediator = new QueryEditorMediator(this, sash, lhs, lhsFolder,
				...
				runQuery, newQuery, deleteQuery, rhs, noSelectionPane,
				selectionPane, descriptionText, idText, showCheck,
				showAtRootCheck, sqlFolder, sql, addSubQuery, deleteSubQuery,
				subQueryTable);
		f_mediator.init();
	}
