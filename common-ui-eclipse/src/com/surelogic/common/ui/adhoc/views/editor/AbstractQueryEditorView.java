...
public abstract class AbstractQueryEditorView extends ViewPart {
  ...
  public void createPartControl(final Composite parent) {
    ...
    final Button noDefaultSubQueryCheck = new Button(selectionPane, SWT.CHECK);
    data = new GridData(SWT.NONE, SWT.CENTER, false, false, 2, 1);
    noDefaultSubQueryCheck.setLayoutData(data);
    noDefaultSubQueryCheck.setText(I18N.msg("adhoc.query.editor.rhs.noDefaultSubQuery"));
    ...
    final Table subQueryTable = new Table(subQueryPane, SWT.BORDER | SWT.FULL_SELECTION | SWT.MULTI);
    data = new GridData(SWT.FILL, SWT.FILL, true, true);
    subQueryTable.setLayoutData(data);
    TableColumn col = new TableColumn(subQueryTable, SWT.NONE);
    col.setText("Default Query Priority");
    col.pack();
