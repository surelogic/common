...
public abstract class AbstractQueryEditorView extends ViewPart {
    ...
    public void createPartControl(final Composite parent) {
        ...
        deleteQuery.setToolTipText(I18N
                .msg("adhoc.query.editor.lhs.tooltip.delete"));

        ToolItem saveQueries = null;
        if (XUtil.useExperimental) {
            new ToolItem(queryToolBar, SWT.SEPARATOR);
            saveQueries = new ToolItem(queryToolBar, SWT.PUSH);
            saveQueries.setImage(SLImages.getImage(CommonImages.IMG_SAVE_EDIT));
            saveQueries.setToolTipText("Save queries.");
            
            new ToolItem(queryToolBar, SWT.SEPARATOR);
            ToolItem exportQueries = new ToolItem(queryToolBar, SWT.PUSH);
            exportQueries.setImage(SLImages.getImage(CommonImages.IMG_SAVEAS_EDIT));
            exportQueries.setToolTipText("Export queries...");
            exportQueries.addListener(SWT.Selection, new Listener() {
                public void handleEvent(final Event event) {
                	new ExportQueryDialog(EclipseUIUtility.getShell(), getManager()).open();
                }
            });
        }
        ...
        final Table queryList = new Table(lhsFolder, SWT.BORDER
        ...
        final Tree queryTree = new Tree(treePane, SWT.BORDER | SWT.H_SCROLL
        ...
        filterTreeCheck.setText(I18N
                .msg("adhoc.query.editor.lhs.filterTreeCheck"));
        data = new GridData(SWT.DEFAULT, SWT.DEFAULT, false, false);
        ...
        sqlTab.setText("SQL");
        final StyledText sql = new StyledText(sqlFolder, SWT.MULTI
        ...
        addSubQuery.setToolTipText(I18N
                .msg("adhoc.query.editor.rhs.tooltip.add"));
        final ToolItem deleteSubQuery = new ToolItem(subQueryToolBar, SWT.PUSH);
        deleteSubQuery
                .setImage(SLImages.getImage(CommonImages.IMG_EDIT_DELETE));
        deleteSubQuery.setToolTipText(I18N
                .msg("adhoc.query.editor.rhs.tooltip.delete"));

        final Table subQueryTable = new Table(subQueryPane, SWT.BORDER
        ...
        f_mediator = new QueryEditorMediator(this, sash, lhs, lhsFolder,
                queryList, queryTree, filterTreeCheck, queryActionMenu,
                runQuery, newQuery, deleteQuery, saveQueries, rhs,
                noSelectionPane, selectionPane, descriptionText, idText,
                cdText, sortHint, type, showCheck, showAtRootCheck, sqlFolder,
                sql, addSubQuery, deleteSubQuery, subQueryTable);
        f_mediator.init();
    }
