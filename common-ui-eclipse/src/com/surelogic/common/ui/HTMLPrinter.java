...
public final class HTMLPrinter {
  ...
  public static String read(final Reader rd) {
    ...
    try {
      ...
      SLLogger.getLogger().log(Level.SEVERE, "Error reading in HTML printer", x);
    }

    return null;
  }

  public static void insertPageProlog(final StringBuffer buffer, final int position, final RGB fgRGB, final RGB bgRGB,
  ...
  public static void insertPageProlog(final StringBuffer buffer, final int position, final RGB fgRGB, final RGB bgRGB) {
    if (bgRGB == null) {
      ...
      pageProlog.append("<html><body text=\"");
      appendColor(pageProlog, fgRGB);
      pageProlog.append("\" bgcolor=\"");
      appendColor(pageProlog, bgRGB);
      pageProlog.append("\">");
  ...
  private static void appendStyleSheetURL(final StringBuffer buffer, final String styleSheet) {
    if (styleSheet == null) {
      return;
    }
  ...
  private static void appendStyleSheetURL(final StringBuffer buffer, final URL styleSheetURL) {
  ...
  public static void insertPageProlog(final StringBuffer buffer, final int position) {
    insertPageProlog(buffer, position, getFgColor(), getBgColor());
  }

  public static void insertPageProlog(final StringBuffer buffer, final int position, final URL styleSheetURL) {
    insertPageProlog(buffer, position, getFgColor(), getBgColor(), styleSheetURL);
  }

  public static void insertPageProlog(final StringBuffer buffer, final int position, final String styleSheet) {
    insertPageProlog(buffer, position, getFgColor(), getBgColor(), styleSheet);
  }
  ...
  public static void addParagraph(final StringBuffer buffer, final Reader paragraphReader) {
    if (paragraphReader != null) {
      addParagraph(buffer, read(paragraphReader));
    }
  }

  public static void insertPageProlog(final StringBuilder buffer, final int position, final RGB fgRGB, final RGB bgRGB,
      final URL styleSheetURL) {
  ...
  public static void insertStyles(final StringBuilder buffer, final String[] styles) {
    if (styles == null || styles.length == 0) {
      return;
    }
  ...
  private static void appendStyleSheetURL(final StringBuilder buffer, final String styleSheet) {
    if (styleSheet == null) {
      return;
    }
  ...
  private static void appendStyleSheetURL(final StringBuilder buffer, final URL styleSheetURL) {
    if (styleSheetURL == null) {
      return;
    }
  ...
  public static void insertPageProlog(final StringBuilder buffer, final int position) {
    insertPageProlog(buffer, position, getFgColor(), getBgColor());
  }

  public static void insertPageProlog(final StringBuilder buffer, final int position, final URL styleSheetURL) {
    insertPageProlog(buffer, position, getFgColor(), getBgColor(), styleSheetURL);
  }

  public static void insertPageProlog(final StringBuilder buffer, final int position, final String styleSheet) {
    insertPageProlog(buffer, position, getFgColor(), getBgColor(), styleSheet);
  }
  ...
  private static RGB getFgColor() {
    if (FG_COLOR_RGB != null) {
      return FG_COLOR_RGB;
    }
    return new RGB(0, 0, 0); // Reasonable fg color if bg is white
  }
  ...
  public static void addSmallHeader(final StringBuilder buffer, final String header) {
    if (header != null) {
      buffer.append("<h5>"); //$NON-NLS-1$
      buffer.append(header);
      buffer.append("</h5>"); //$NON-NLS-1$
  ...
  public static void addParagraph(final StringBuilder buffer, final String paragraph) {
    if (paragraph != null) {
      buffer.append("<p>"); //$NON-NLS-1$
      buffer.append(paragraph);
    }
  ...
  public static void addParagraph(final StringBuilder buffer, final Reader paragraphReader) {
    if (paragraphReader != null) {
      addParagraph(buffer, read(paragraphReader));
    }
  }
   ...
   * @since 3.3
   */
  public static String convertTopLevelFont(String styles, final FontData fontData) {
    ...
    final String size = Integer.toString(fontData.getHeight()) + ("carbon".equals(SWT.getPlatform()) ? "px" : "pt"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
