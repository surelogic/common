...
public final class JavaSyntaxHighlighter {
  ...
  private boolean isNested(StyleRange sr) {
    ...
    for (StyleRange esr : f_result) {
      ...
      /*
       * = (srB <= esrB && srE >= esrB) || (srB >= esrB && srE <= esrE) || (srB
       * <= esrB && srE >= esrE) || (srB <= esrE && srE >= esrE);
       */
      if (overlaps)
        return true;
    }
  ...
  static private final String[] RESERVED_WORDS = { "abstract", "assert", "boolean", "break", "byte", "case", "catch", "char",
      "class", "const", "continue", "default", "do", "double", "else", "extends", "false", "final", "finally", "float", "for",
      "goto", "if", "implements", "import", "instanceof", "int", "interface", "long", "native", "new", "null", "package",
