...
public class EmailContextListener implements ServletContextListener {
	...
	public void contextInitialized(final ServletContextEvent event) {
		...
		jmProps.setProperty("mail.smtp.host", config
				.getInitParameter("emailServerHost"));
		jmProps.setProperty("mail.smtp.port", config
				.getInitParameter("emailServerPort"));
		...
		bugProps.setProperty("bugzillaPassword", config
				.getInitParameter("bugzillaPassword"));
		bugProps.setProperty("bugzillaURL", config
				.getInitParameter("bugzillaURL"));
