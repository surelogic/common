...
public interface BugzillaConstants {
	...
	// Required - A version of the product above; the version the bug was found in. 
	public static final String VERSION = "version";
	
	// Defaulted - The initial description for this bug. Some Bugzilla installations require this to not be blank. 
