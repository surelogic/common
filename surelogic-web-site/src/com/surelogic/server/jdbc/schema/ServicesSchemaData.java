...
public class ServicesSchemaData extends AbstractSchemaData {
	public ServicesSchemaData() {
		super("com.surelogic.server.jdbc.schema", Thread.currentThread()
				.getContextClassLoader(), SLLicenseProduct.EXEMPT);
	}

	protected Object newInstance(String qname) throws InstantiationException,
