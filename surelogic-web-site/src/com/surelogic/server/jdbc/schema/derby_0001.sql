...
<<>>
CREATE LICENSE_NETCHECK_DESCRIPTION_HOLDER_INDEX ON LICENSE_NETCHECK_DESCRIPTION (HOLDER)
<<>>
CREATE LICENSE_NETCHECK_DESCRIPTION_EMAIL_INDEX ON LICENSE_NETCHECK_DESCRIPTION (EMAIL)
<<>>
CREATE LICENSE_NETCHECK_DESCRIPTION_COMPANY_INDEX ON LICENSE_NETCHECK_DESCRIPTION (COMPANY)
<<>>
...
<<>>
CREATE LICENSE_WEB_REQUEST_EMAIL_INDEX ON LICENSE_WEB_REQUEST (EMAIL)
<<>>
CREATE LICENSE_WEB_REQUEST_COMPANY_INDEX ON LICENSE_WEB_REQUEST (COMPANY)
<<>>
