...
public final class NonLeafTreeCell extends TreeCell {
   ...
   * summaries.
   * <p>
   * Each column summary contains the index of the column it should be displayed
   * in and some text. The indices should refer to columns in the table portion
   * of the tree-table.
   * <p>
   * The returned list should not be mutated.
   * 
   ...
   * 
   * @return the set of leaf cells below this cell. This set might be empty but
   ...
   */
  private void getLeavesHelper(List<TreeCell> children, Set<LeafTreeCell> mutableResult) {
    if (children == null)
      return;
