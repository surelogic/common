...
public interface IAdHocManagerObserver {
	...
	/**
	 * Invoked when something about the set of queries owned by a query manager
	 * has changed.
	 * <p>
	 ...
	 * result that should be displayed in the user interface. The selected
	 * result may be {@code null} if no result is selected or if there are no
	 * results.
	 * <p>
	 * This is triggered via a client call to
