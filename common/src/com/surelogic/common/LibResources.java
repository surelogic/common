...
public class LibResources {
	 ...
	 */
	public static final String PROMISES_JAR = "promises-5.5.1.jar";
	...
	public static final String[] PROMISES_JAR_OLD_VERSIONS = { "promises.jar",
			...
			"promises-4.4.0.jar", "promises-5.0.0.jar", "promises-5.1.0.jar",
			"promises-5.2.0.jar", "promises-5.5.0.jar"};
