...
public final class CoE_Constants {
  ...
  public static final String RESULT_BACK_LINK = XMLUtil.startNode(RESULT_TAG) + ATTR_MESSAGE
      + "=\"(Skipped reference to parent node to avoid loop)\"/>";
  ...
  /** Flag to render the delta adornment */
  public final static int DELTA = 0x100;

  /*
   * Tags for source files Duplicated in common-eclipse/SourceZip
   */
