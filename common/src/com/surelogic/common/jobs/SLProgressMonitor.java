...
public interface SLProgressMonitor {
	 ...
	 * once (implementations should be prepared to handle this case). Also
	 * closes any subtasks that are still "open." That is, the progress monitor
	 * should behave as if {@link #subTaskDone()} has been called for any
	 * subtasks that are still unfinished.
	 */
	public void done();
