 ...
 * @param <T>
 */
public final class LimitRowHandler<T> implements
        ResultHandler<LimitedResult<T>> {
     ...
     * @return
     */
    public static <T> ResultHandler<LimitedResult<T>> from(
            final RowHandler<T> handler, final int limit) {
